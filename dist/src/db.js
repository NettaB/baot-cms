...
var client = new mongodb_1.MongoClient(url, { useNewUrlParser: true });
var init = function () {
...
var createOne = function (collectionName) { return function (item) { return __awaiter(_this, void 0, void 0, function () {
    var response;
...
var readOne = function (collectionName) { return function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, baotDB
